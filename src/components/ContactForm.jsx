...
function ContactForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-200 ">
      ...
      <form classNaame="" onSubmit={handleSubmit}>
        <input
          type="text"
          placeholder="Enter your name"
          value={name}
          onChange={(e) => setName(e.target.value)}
          className="w-full p-3 border border-black-300 rounded-lg "
        />
        <br /><br />
        ...
        <br /><br />
        <button type="submit" className="w-full bg-blue-400 p-3 rounded-lg hover:bg-blue-700">submit</button>
      </form>
